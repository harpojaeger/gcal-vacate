...
import {
    EventWithSelectableInstances,
    setInstanceSelected,
    setAllEventInstancesSelected,
} from '../../store/events';
...
export default ({
    ...
    event: EventWithSelectableInstances;
    eventIndex: number;
}) => {
    ...
    function handleEventSelection(
        ...
        dispatch(
            setAllEventInstancesSelected({ eventIndex, eventId, selected })
        );
    }
    ...
    return (
        <div key={event.eventId}>
            ...
            <label htmlFor={event.eventId}>
                name: {event.summary}, all selected:{' '}
                {allInstancesSelected ? 'yup' : 'nope'}
            </label>
            <br />
            instances:
            <ul>
